export const queryleaderboardHomeTeam = `SELECT t.team_name AS name,
COUNT(t.team_name) AS totalGames,
CAST(((SUM(m.home_team_goals > m.away_team_goals) * 3) 
+ SUM(m.home_team_goals = m.away_team_goals))AS SIGNED) AS totalPoints,
...
export const queryleaderboardAwayTeam = `SELECT t.team_name AS name,
COUNT(t.team_name) AS totalGames,
